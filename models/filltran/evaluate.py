...
def sample(args):
    ...
    # Load model
    model_config['data_url'] = '/home/ma-user/work/logs'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img', type=str, default='old_photos')
    parser.add_argument('--dir', type=str, default='/home/ma-user/work/logs/filltran')
    parser.add_argument('--step', type=str, default='560531')
